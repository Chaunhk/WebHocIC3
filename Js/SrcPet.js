...
function updateMyHomeUI() {
  document.getElementById("home-stats-details").innerHTML = `
    ...
    `;
  document.getElementById("home-coin-val").innerHTML =
    `🪙 ${currentUser.coin || 0}`;
  document.getElementById("home-win-val").innerText =
    `Thắng: ⚔️ ${currentUser.win || 0}`;

  const petImgEl = document.getElementById("display-pet-img");
  petImgEl.src =
    currentUser.petImg && currentUser.petImg !== ""
      ? currentUser.petImg
...
function handlePvPBattle() {
  ...
  document.getElementById("battle-my-pet").src =
    currentUser.petImg && currentUser.petImg !== ""
      ? currentUser.petImg
      : "https://i.imgur.com/B9OQfC7.png";
  document.getElementById("battle-my-name").innerText = currentUser.hoten;

  document.getElementById("battle-enemy-pet").src =
    randomEnemy.petImg && randomEnemy.petImg !== ""
      ? randomEnemy.petImg
      : "https://i.imgur.com/B9OQfC7.png";
